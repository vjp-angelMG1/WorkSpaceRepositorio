 ...
 * @author Angel
 */
public class Leones extends Felinos{ //hereda de la clase padre
    //no tiene atributos
    //CONSTRUCTORES
    //por defecto
    public Leones(){
    ...
    //metodos abstractos de la clase abuela
    @Override
    public void sonido() {
    ...
    public void nombreCientifico(){
        System.out.println("Su nombre cientifico es Pathera Leo");
    }
    //metodo ToString
    @Override
    public String toString() {
        return super.toString()+"Leones{" + '}';
    }
