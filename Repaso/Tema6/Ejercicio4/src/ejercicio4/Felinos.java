 ...
 * @author Angel
 */
public abstract class Felinos extends Animal{ //sigue siendo clase abstracta ya que no tiene atributos y quiero utilizar los metodos abstractos de la clase abuela donde la nieta
    //no tiene atributos
    //CONSTRUCTORES
    //por defecto
    public Felinos() {
