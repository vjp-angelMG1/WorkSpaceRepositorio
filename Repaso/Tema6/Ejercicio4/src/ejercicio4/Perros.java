 ...
 * @author Angel
 */
public class Perros extends Canidos{//hereda de la clase padre
//no tiene atributos
//CONSTRUCTORES
//por defecto
    public Perros(){    
...
//metodos abstractos heredados de la clase abuela
    @Override
    public void sonido() {
        System.out.println("El sonido que tiene es el ladrido");
    }
    @Override
    ...
    public void nombreCientifico(){
        System.out.println("el nombre cientifico es Pathera Leo");
    }

    //metodo ToString
    @Override
    public String toString() {
        return super.toString()+"Perros{" + '}';
    }
