...
public class ejercicio1numeropositivoonegativo {

public static int pedirNum() { //método en el que nombramos con int para pedir numero
    ...
    public static void main(String[] args) { //método main que llama al otro metodo para pedirle el numero
        int numero1 = ejercicio1numeropositivoonegativo.pedirNum(); //declaro la variable con la llamada al metodo pedirNum numero para que me devuelva el valor 

        if (numero1 > 0) { //condicional si el numero1 que me ha devuelto es mayot que 0 entonces es positivo
            System.out.println("El numero es positivo"); //Imprimo el valor de la variable
        } else if (numero1 < 0) { //condicional si el numero1 que me ha devuelto es mayor que 0 entonces es negativo
